...
![image-20230427104538596](web.assets/image-20230427104538596.png)

<br>聪明的你应该发现了，只需要引入“相对地址”，并上传到Github仓库中，就可以完成图片媒体的配置。需要注意的是，有的同学可能知道“图床技术”，但对于个人站点而言，这类需要长期维护的网站，强烈不建议使用第三方图床服务——如果图片挂了，你需要花费超大量的时间来转移图片链接——别问笔者为什么清楚，“都是一把辛酸泪”。
